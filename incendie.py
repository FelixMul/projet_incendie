...
Bouton_load.grid(row=0, column=0)
Bouton_step.grid(row=0, column=0)
Bouton_start.grid(row=0, column=0)
Bouton_stop.grid(row=0, column=0)
Bouton_speedup.grid(row=0, column=0)
Bouton_speeddown.grid(row=0, column=0)